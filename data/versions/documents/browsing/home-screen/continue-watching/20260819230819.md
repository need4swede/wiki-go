...
If [Impatient Mode](/settings/home#impatient-mode) is enabled, the card starts playback immediately and resumes from its saved position.
Turn on [**Limit to Continue Watching / Next-Up**](/settings/home#impatient-mode) under **Settings > Home > Navigation** to keep that shortcut here and in Next Up while other cards continue opening their normal destinations.
