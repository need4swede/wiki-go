...
DTS-HD Master Audio decodes its full lossless extension, while DTS-HD High Resolution decodes its higher-bitrate lossy extension. Both support up to 7.1 channels and are decoded locally to multichannel PCM for the connected output.
