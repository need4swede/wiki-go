...
Trident is the default engine. If you ever need Apple's native player instead, switch the **Engine** in **Settings > Playback** (the native player leans on server transcoding for formats it can't handle).
