...
Neptune Pro expands Neptune's capabilities for Pro users: intelligence built specifically for Neptune, richer connected metadata, adaptive playback preferences, offline media, and deeper Apple TV presentation controls.
...
| Experience | Free | Neptune Pro |
|------------|------|-------------|
| **Playback** | Every supported codec, format, HDR profile, audio format, and subtitle type | The same complete playback engine |
| **Conductor** | Manual rules automatically select tracks and versions | Auto mode adapts and learns from your choices over time |
| **AI features** | Use third-party provider with your own compute or API key | Use the integrated, official first-party Neptune AI service |
...
Pro raises the ceiling without weakening the free player. If a Pro feature is not active, Neptune falls back to its complete free behavior rather than degrading playback.
...
The purchase is universal across Neptune's Apple platforms. Buy once with the same App Store account and restore it on Apple TV, iPhone, and iPad. Lifetime also includes access to the [Pilot program](/getting-started/installation#passengers--pilots) for preview builds of released platforms.
...
- Downloads and their management surfaces become unavailable. Existing files and progress remain on the device, and paused transfers require an explicit Resume after Pro returns.
...
| Page | Focus |
|------|-------|
| [Conductor Pro](/neptune-pro/conductor-pro) | Adaptive playback learning |
| [Neptune AI](/neptune-pro/neptune-ai) | First-party hosted intelligence |
| [TMDB Integration](/neptune-pro/tmdb-integration) | Connected metadata enrichment |
| [Downloads](/neptune-pro/downloads) | Offline media |
| [Top Shelf Customization](/neptune-pro/top-shelf-customization) | Apple TV Home Screen presentation |
