...
|---|-----------------------------|--------------------------|
| **Starting point** | Your language, foreign-content, anime, subtitle, and quality rules | The same rules |
| **Per-file memory** | No | Remembers the exact confirmed tracks and version for that file |
| **Series learning** | No | Recognizes recurring audio, subtitle, codec, channel, and language-variant choices across episodes |
| **Broader preferences** | Fixed until you edit Settings | Builds standing preferences from repeated choices |
| **In-player changes** | Apply to the current session | Apply immediately and can become learning signals |
