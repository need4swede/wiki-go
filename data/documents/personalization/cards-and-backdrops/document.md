...
Fine-tune how much artwork Neptune shows and how content cards present themselves. Both live in **Settings > User Preferences > Appearance**.
...
| Setting | Description |
|---------|-------------|
| **Hide Spoilers** | Blur unwatched episode cards and their metadata app-wide |
...
Hide Spoilers pairs with the per-show Spoilers toggle on series pages (see [TV Shows](/browsing/item-details/tv-shows)).
