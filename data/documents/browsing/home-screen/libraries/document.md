...
| Tab | What's Shown |
|-----|--------------|
| **Home** | All supported media libraries |
...
Open **Settings > Home > Library** to:

- Reorder or hide individual libraries
- Choose whether cards show titles, years, and labels
...
- Library order and visibility are saved per profile.
- A library hidden from this row remains available from the main [Library](/library) tab unless server permissions also hide it.
- The row disappears when no matching libraries are available for the current tab.
