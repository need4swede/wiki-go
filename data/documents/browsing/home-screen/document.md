...
|----------|------|----------|
| 1 | **New Episodes** | Episodes added in last 7 days from shows you're caught up on |
| 2 | **New Releases** | Movies added in last 14 days that are actual new releases |
| 3 | **Continue Watching** | Fallback: episodes from your Next Up queue |
| 4 | **Recently Added** | Fallback: latest movies added to your library |

Each item shows a **reason badge** (purple for new episodes, blue for new releases, orange for continue watching, green for recently added).

### Navigation

- **Left/Right swipe:** Browse between spotlight items
- **Select (click):** Go directly to item details
