...
The same account-scoped Pins list is filtered to match the current tab.
The Home tab shows every native Pin, while the Movies, Shows, and Music tabs show only pins for that content type.
