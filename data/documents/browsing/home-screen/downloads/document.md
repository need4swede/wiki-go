...
On the Movies and Shows tabs, the row filters itself to the matching media type. The Home tab shows both.



## Navigation and Management

Select a movie or series to open its detail page. Completed items play from local storage when the server is unavailable.

Long-press a card to manage its download. For the full device-wide view—including failed or evicted items—open **Settings > Downloads**, where downloads are grouped into Movies and Shows and can be sorted or removed.
