...
> There are more tabs available than what's enabled by default, including the dedicated **Movies**, **Shows**, and **Music** tabs. Movies and Shows filter the shared Home experience by media type, while Music provides an artist-first music-video experience. Turn them on in **Settings > Home > Navigation**.
...
On the Movies and Shows tabs, servers with more than one library of that type get a picker row. Selecting a library scopes the whole tab to it. Music combines music-video libraries into one artist-first view instead of using this picker.
