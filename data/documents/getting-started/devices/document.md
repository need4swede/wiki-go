...
Whatever device you pick up, you get the same home screen, the same search, the same Discover, the same [Conductor](/playback/conductor) picking your tracks, and the same [Trident](/playback/trident-player) engine playing your files.
Sign in with the same account and your profile is your profile.

With the [Neptune MDM](/plugins/mdm) plugin installed, preferences sync live: change your theme on one device and your other Neptune clients follow in real time.
Without it, each device keeps its own local settings.

## Shaped to the Screen

The interface adapts to how you actually hold and use each device:
...
Neptune keeps three shortcut systems deliberately separate:

- **Native Pins** are cross-platform bookmarks for media, people, and library browse contexts.
- **Conventional widgets** work on iPhone and iPad.
  Every widget independently selects a Neptune Page, dynamic Section, or native Pin.
...
Apple TV is on the App Store. iPhone and iPad are in open beta through TestFlight (see [Installation](/getting-started/installation)).
If something you rely on hasn't made it to your device yet, the fastest way to flag it is through the <a href="https://discord.gg/HTuf4HPMbP" target="_blank">Neptune Discord</a>.
