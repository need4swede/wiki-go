...
Neptune begins with ten themes:
...
2. Select the trailing **Add** card.
3. Enter at least two characters in **Search Keywords**.
4. Select the plus beside a result.
...
| Feature | Catalog | Best For |
|---------|---------|----------|
| **Themed Collections** | Seerr/TMDB, including media you do not own | Discovering and requesting new content |
| [Smart Tags](/library/smart-tags) | Neptune's on-device semantic catalog matched to your library | Exploring content you already have |

The two can use similar words but answer different questions: “What could I add?” versus “What can I watch now?”
