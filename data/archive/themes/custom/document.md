...
2. Go to **Settings > User Preferences > Appearance**.
3. Select **Import Custom Theme**.
4. Paste the URL and select **Import**.
5. Neptune downloads, validates, and applies the theme. Imported themes show a **Custom** badge in the picker.
...
- [Ocean](https://github.com/need4swede/neptune/blob/main/docs/themes/ocean.json)
...
- [Ember](https://github.com/need4swede/neptune/blob/main/docs/themes/ember.json)
